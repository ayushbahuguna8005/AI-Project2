...
def num_neighbour(train_X, train_Y, testX, targetTest):
   train_results = []
   test_results = []
...
print('dataset 1')
num_neighbour(train_X, train_Y, testX, targetTest)
...
num_neighbour(train_GreekX, train_GreekY, testGreekX, testGreekTarget)
